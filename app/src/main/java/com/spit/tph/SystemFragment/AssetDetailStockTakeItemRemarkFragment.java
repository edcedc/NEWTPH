...
import com.spit.tph.Entity.RenewEntity.ManualUpdateEvent;
...
import com.spit.tph.Event.DeletePosition;
...
import com.spit.tph.Request.StockTakeListItemRemarkRequest;
import com.spit.tph.Request.UploadPhotoRequest;
import com.spit.tph.Response.LoginResponse;
import com.spit.tph.WebService.Callback.GetRemarkCallback;
import com.spit.tph.WebService.Callback.GetStatusCallback;
import com.spit.tph.WebService.Callback.UploadStockTakeListRemarkCallback;
