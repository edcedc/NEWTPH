...
import com.spit.tph.UnsafeOkHttpClient;
...
public class RetrofitClient {
    ...
    public static com.spit.tph.WebService.SPGetWebService SPGetWebService = null;
    ...
    public static com.spit.tph.WebService.SPGetWebService getSPGetWebService() {
        //if(SPGetWebService == null) {
            SPGetWebService = getSPGetWebClient().create(com.spit.tph.WebService.SPGetWebService.class);
        //}
