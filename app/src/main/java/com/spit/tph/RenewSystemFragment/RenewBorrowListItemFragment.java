...
import com.spit.tph.Event.NetworkRecallEvent;
...
import com.spit.tph.RenewSystemFragment.Upload.UploadBorrowListItem;
...
public class RenewBorrowListItemFragment extends BaseFragment {
    ...
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void onMessageEvent(com.spit.tph.Event.BarcodeScanEvent event) {
